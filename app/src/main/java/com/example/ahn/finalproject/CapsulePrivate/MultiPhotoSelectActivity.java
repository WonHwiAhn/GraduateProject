...
public class MultiPhotoSelectActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*if (savedInstanceState == null) {
            ...
            CapsulePrivateMainFragment details = new CapsulePrivateMainFragment();
    ...
    public void btnChoosePhotosClick(View v){
        ...
        if (selectedItems!= null && selectedItems.size() > 0) {
            ...
            //CapsulePrivateMainFragment fr = new CapsulePrivateMainFragment();
            /*Bundle args = new Bundle() ;
            args.putString("selectItem", selectedItems.toString());
            ...
            String itemCore = selectedItems.toString().replace("[", "");
            itemCore = itemCore.replace("]", "");
            itemCore = itemCore.replaceAll(" ", "");

            Intent intent = new Intent(getApplicationContext(), CapsulePrivateMainFragment.class);
            intent.putExtra("selectItem", itemCore);
